...
class GenerateRecommendations(Construct):
    def __init__(
        self,
        scope: Construct,
        construct_id: str,
        ...
        **kwargs,
            ...
            options=apigw.IntegrationOptions(
                ...
                request_templates=
                {
                    ...
                    {{
                        ...
                        "input": "{{\\"httpMethod\\": \\"$context.httpMethod\\",\\"path\\": \\"$context.path\\",\\"id\\": \\"$inputPath.id\\"}}"
        ...
        child_resource = api.root.get_resource("references2")
        if not child_resource:
            child_resource = api.root.add_resource("references2")
